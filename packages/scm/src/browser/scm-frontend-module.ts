...
import {
    ...
    createTreeContainer, TreeWidget, TreeProps
...
export default new ContainerModule(bind => {
    ...
    bind(ScmTreeWidget).toDynamicValue(ctx => createFileChangeTreeWidget(ctx.container));
    bind(WidgetFactory).toDynamicValue(({ container }) => ({
        id: ScmTreeWidget.ID,
...
export function createFileChangeTreeWidget(parent: interfaces.Container): ScmTreeWidget {
